...
class SelectionScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    Future<Recruiter> getRecruiterData() => Preferences().getRecruiter();
    final size = MediaQuery.of(context).size;
    return Scaffold(
      body: FutureBuilder<Recruiter>(
        future: getRecruiterData(),
            ...
            case ConnectionState.waiting:
              ...
              default:
                if(snapshot.hasError)
                 return LoadingScreen();
                else if( snapshot.data!.fcmToken == "" || snapshot.data!.fcmToken == null )
                  return Container(
                    height: size.height,
                    width: size.width,
                  ...
                  Preferences().removeRecruiter();
                print("phone: ${snapshot.data!.phoneNumber}");
                return NavScreen(recruiter: snapshot.data!,);
          }
        },
      ),
    );
