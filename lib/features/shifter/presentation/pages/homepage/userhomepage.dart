...
import 'package:shifter/features/shifter/presentation/services/recruiter_service.dart';
import 'package:shifter/features/shifter/presentation/view_models/recruiter_view_model.dart';
...
class _UserHomePageState extends State<UserHomePage> {
  ...
  @override
  void initState()  {
    RecruiterProvider recruiterProvider =
    Provider.of<RecruiterProvider>(context, listen: false);
    RecruiterService.getRecruiter("1", recruiterProvider);
    setState(() {
      _isLoading = true;
    });
    super.initState();
  ...
  Widget build(BuildContext context) {
    RecruiterProvider recruiterProvider = Provider.of<RecruiterProvider>(context);
    return _isLoading
        ? Scaffold(
            extendBodyBehindAppBar: true,
            backgroundColor: Colors.white,
            body: SingleChildScrollView(
                child: FutureBuilder<RecruiterProvider>(
                  future: recruiterProvider.fetchRecruiter(),
                                                  ...
                                                  Center(
                                                    child: Padding(
                                                      ...
                                                      const EdgeInsets
                                                          .all(18.0),
                                                      child: Text(
                                                        "Candidate description, Lorem ipsum dolor sit amet,consectetur adipiscing elit, consectetur adipiscing elit, sed do eiusmod tempor,consectetur adipiscing elit, ",
                                                        maxLines: 3,
                                                        overflow:
                                                        TextOverflow
                                                            .ellipsis,
